#include "com_movlad_pcl_visualization_Visualizer3d.h"
...
jboolean Java_com_movlad_pcl_visualization_Visualizer3d_addPointCloud(JNIEnv *env, jobject obj, jobject cloud, jstring id, jint viewport)
{
...
jboolean Java_com_movlad_pcl_visualization_Visualizer3d_addPointCloudNormals(JNIEnv *env, jobject obj, jobject cloud, jobject normals, jint level, jfloat scale, jstring id, jint viewport)
{
	pcl::visualization::PCLVisualizer::Ptr vis_ptr =
		sptr_wrapper<pcl::visualization::PCLVisualizer>::get_sptr(env, obj);
